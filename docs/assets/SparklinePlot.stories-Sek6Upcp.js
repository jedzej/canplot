      ...
      padding: "20px"
        ...
        borderRadius: "8px"
          ...
          scales
            ...
            {/* Full opacity */}
            <SparklinePlot data={data1} xScaleId="x" yScaleId="y" stroked style={{
            strokeStyle: "#ff6b6b",
            lineWidth: 1.5,
            fillStyle: "#ff6b6b"
          }} globalAlpha={1} />
            ...
            {/* 60% opacity */}
            <SparklinePlot data={data2} xScaleId="x" yScaleId="y" stroked style={{
            strokeStyle: "#51cf66",
            lineWidth: 1.5,
            fillStyle: "#51cf66"
          }} globalAlpha={0.6} />
            ...
            {/* 30% opacity */}
            <SparklinePlot data={data3} xScaleId="x" yScaleId="y" stroked style={{
            strokeStyle: "#4c6ef5",
            lineWidth: 1.5,
            fillStyle: "#4c6ef5"
          }} globalAlpha={0.3} />
...
}`,...j.parameters?.docs?.source}}};const F=["Basic","WithInteractions","TimeSeries","MultipleSparklines","MinimalSparkline","StockPrice","VolatileData","DifferentFillStyles","WithStrokeOnly","WithFillOnly","MixedStrokeAndFill","DashboardStyle","GlobalAlpha"];export{c as Basic,v as DashboardStyle,b as DifferentFillStyles,j as GlobalAlpha,m as MinimalSparkline,I as MixedStrokeAndFill,p as MultipleSparklines,f as StockPrice,g as TimeSeries,S as VolatileData,u as WithFillOnly,h as WithInteractions,k as WithStrokeOnly,F as __namedExportsOrder,R as default};
