import{j as k}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./iframe-mNfbeEQq.js";import{u as p}from"./ChartAreaInteractions-82LHt42F.js";import{c as u,a as m}from"./CanPlot-Bu1g0GpU.js";const g=({makeClassName:s,makeStyle:o})=>{const[e,y]=i.useState(null);p("spanselect",n=>{y(n.mode==="none"||n.completed?null:n)});const r=i.useMemo(()=>{if(!e)return null;const n=u(e.frame,e.x.fromCSS,"css"),a=u(e.frame,e.x.toCSS,"css"),t=m(e.frame,e.y.fromCSS,"css"),l=m(e.frame,e.y.toCSS,"css"),S=Math.min(n,a),v=Math.min(t,l),d=Math.abs(a-n),b=Math.abs(l-t);return{leftPx:S,topPx:v,widthPx:d,heightPx:b}},[e]);return k.jsx("div",{className:e?s?.(e):void 0,style:{position:"absolute",visibility:e?"visible":"hidden",left:`${r?.leftPx??0}px`,top:`${r?.topPx??0}px`,width:`${r?.widthPx??0}px`,height:`${r?.heightPx??0}px`,pointerEvents:"none",...e?o?.(e):void 0}})};g.__docgenInfo={description:"",methods:[],displayName:"SelectBox",props:{makeClassName:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectState: SpanSelectEvent) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  frame: PlotDrawFrame;
  mode: "x" | "y" | "box" | "none";
  x: {
    fromCSS: number;
