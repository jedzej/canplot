import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as k,b as z,C as c}from"./CanPlot-DVC1qZKh.js";import{S as P}from"./ScatterPlot-Dwv4ocoC.js";import{C as x}from"./ChartAreaInteractions-B6TFcj4d.js";import{C as p}from"./CrossHair-CjdBJ5eZ.js";import{S as g}from"./SelectBox-jJq3WkBF.js";import"./iframe-DpcP5qQz.js";import"./preload-helper-PPVm8Dsz.js";const s=({data:a,xScaleId:i,yScaleId:n,style:t})=>(k(({getCtx:r,clampXPosToChartArea:l,clampYPosToChartArea:C,valToPos:b})=>{const d=[];for(const y of a){const A=l(b(y.x,i)),j=C(b(y.y[0],n)),M=C(b(y.y[1],n));d.push({x:A,y:j}),d.unshift({x:A,y:M})}const o=r();if(d.length>0){o.save(),o.beginPath(),z(o,t),o.moveTo(d[0].x,d[0].y);for(const y of d)o.lineTo(y.x,y.y);o.closePath(),o.fill(),o.restore()}},[a,i,n,t]),null),D={title:"CanPlot/AreaPlot",component:c,parameters:{layout:"fullscreen"},tags:["autodocs"]},m={render:()=>{const a=[{id:"x",type:"linear",axis:{position:"bottom",size:40},origin:"x",min:0,max:100},{id:"y",type:"linear",axis:{position:"left",size:40},origin:"y",min:0,max:100}];return e.jsx("div",{style:{padding:"20px"},children:e.jsx(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:a},children:e.jsx(s,{data:Array.from({length:50},(i,n)=>({x:n*2,y:[30+Math.sin(n/5)*15,70+Math.sin(n/5)*15]})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(66, 153, 225, 0.5)"}})})})}},h={render:()=>{const a=[{id:"x",type:"linear",axis:{position:"bottom",size:40},origin:"x",min:0,max:100},{id:"y",type:"linear",axis:{position:"left",size:40},origin:"y",min:0,max:100}];return e.jsx("div",{style:{padding:"20px"},children:e.jsxs(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:a},children:[e.jsxs(x,{sync:{key:"area",xViaScaleId:"x",yViaScaleId:"y"},children:[e.jsx(p,{}),e.jsx(g,{style:{backgroundColor:"#4299e144"}})]}),e.jsx(s,{data:Array.from({length:60},(i,n)=>{const t=n*1.67,r=50+Math.sin(n/8)*20,l=15+Math.cos(n/10)*10;return{x:t,y:[r-l,r+l]}}),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(72, 187, 120, 0.6)"}})]})})}},f={render:()=>{const a=Date.parse("2025-11-01T12:00:00Z"),i=[{id:"t",type:"time",timeZone:"UTC",axis:{position:"bottom",size:50},origin:"x",min:a-1e3*60*60*24*7,max:a},{id:"y",type:"linear",axis:{position:"left",size:50},origin:"y",min:0,max:100}];return e.jsx("div",{style:{padding:"20px"},children:e.jsxs(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:i},children:[e.jsxs(x,{sync:{key:"timeseries-area",xViaScaleId:"t",yViaScaleId:"y"},children:[e.jsx(p,{}),e.jsx(g,{style:{backgroundColor:"#ed8936aa"}})]}),e.jsx(s,{data:Array.from({length:100},(n,t)=>{const r=a-6048e5+t*1e3*60*60*24*7/100,l=50+Math.sin(t/10)*20;return{x:r,y:[l-15,l+15]}}),xScaleId:"t",yScaleId:"y",style:{fillStyle:"rgba(237, 137, 54, 0.5)"}})]})})}},S={render:()=>{const a=[{id:"x",type:"linear",axis:{position:"bottom",size:40},origin:"x",min:0,max:100},{id:"y",type:"linear",axis:{position:"left",size:40},origin:"y",min:0,max:100}];return e.jsx("div",{style:{padding:"20px"},children:e.jsxs(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:a},children:[e.jsxs(x,{sync:{key:"multi-area",xViaScaleId:"x",yViaScaleId:"y"},children:[e.jsx(p,{}),e.jsx(g,{style:{backgroundColor:"#9f7aea44"}})]}),e.jsx(s,{data:Array.from({length:50},(i,n)=>({x:n*2,y:[10+Math.sin(n/5)*8,30+Math.sin(n/5)*8]})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(66, 153, 225, 0.4)"}}),e.jsx(s,{data:Array.from({length:50},(i,n)=>({x:n*2,y:[40+Math.cos(n/6)*10,60+Math.cos(n/6)*10]})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(72, 187, 120, 0.4)"}}),e.jsx(s,{data:Array.from({length:50},(i,n)=>({x:n*2,y:[70+Math.sin(n/4)*6,90+Math.sin(n/4)*6]})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(237, 137, 54, 0.4)"}})]})})}},u={render:()=>{const a=[{id:"x",type:"linear",axis:{position:"bottom",size:40},origin:"x",min:0,max:100},{id:"y",type:"linear",axis:{position:"left",size:40},origin:"y",min:0,max:100}],i=Array.from({length:40},(n,t)=>({x:t*2.5,center:50+Math.sin(t/5)*25}));return e.jsx("div",{style:{padding:"20px"},children:e.jsxs(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:a},children:[e.jsxs(x,{sync:{key:"area-scatter",xViaScaleId:"x",yViaScaleId:"y"},children:[e.jsx(p,{}),e.jsx(g,{style:{backgroundColor:"#f6ad5544"}})]}),e.jsx(s,{data:i.map(n=>({x:n.x,y:[n.center-12,n.center+12]})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(159, 122, 234, 0.3)"}}),e.jsx(P,{data:i.map(n=>({x:n.x,y:n.center})),xScaleId:"x",yScaleId:"y",style:{fillStyle:"#805ad5",strokeStyle:"#553c9a",lineWidth:2}})]})})}},I={render:()=>{const a=[{id:"x",type:"linear",axis:{position:"bottom",size:40},origin:"x",min:0,max:100},{id:"y",type:"linear",axis:{position:"left",size:40},origin:"y",min:0,max:100}];return e.jsx("div",{style:{padding:"20px"},children:e.jsxs(c,{style:{width:"100%",height:"400px"},configuration:{padding:{bottom:20,left:20,right:20,top:20},scales:a},children:[e.jsxs(x,{sync:{key:"confidence",xViaScaleId:"x",yViaScaleId:"y"},children:[e.jsx(p,{}),e.jsx(g,{style:{backgroundColor:"#fc864944"}})]}),e.jsx(s,{data:Array.from({length:100},(i,n)=>{const t=n*1.25,r=50+(t-50)*.3;return{x:t,y:[r-20,r+20]}}),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(252, 129, 129, 0.2)"}}),e.jsx(s,{data:Array.from({length:100},(i,n)=>{const t=n*1.25,r=50+(t-50)*.3;return{x:t,y:[r-8,r+8]}}),xScaleId:"x",yScaleId:"y",style:{fillStyle:"rgba(252, 129, 129, 0.5)"}}),e.jsx(P,{data:Array.from({length:80},(i,n)=>{const t=n*1.25;return{x:t,y:50+(t-50)*.3}}),xScaleId:"x",yScaleId:"y",style:{fillStyle:"#c92a2a",strokeStyle:"#c92a2a",lineWidth:2}})]})})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...I.parameters?.docs?.source}}};const E=["Basic","WithInteractions","TimeSeries","MultipleAreas","WithScatterOverlay","ConfidenceBands"];export{m as Basic,I as ConfidenceBands,S as MultipleAreas,f as TimeSeries,h as WithInteractions,u as WithScatterOverlay,E as __namedExportsOrder,D as default};
