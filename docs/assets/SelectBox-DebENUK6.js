import{j as b}from"./jsx-runtime-D_zvdyIk.js";import{r as k}from"./iframe-D0RbRrVO.js";import{u as p}from"./ChartAreaInteractions-BSwIeNTT.js";import{c as i,a as u}from"./CanPlot-CfMimGA8.js";const g=({makeClassName:m,makeStyle:s})=>{const[e,o]=k.useState(null);if(p("spanselect",n=>{o(n.mode==="none"||n.completed?null:n)}),!e)return null;const r=i(e.frame,e.x.fromCSS,"css"),a=i(e.frame,e.x.toCSS,"css"),t=u(e.frame,e.y.fromCSS,"css"),l=u(e.frame,e.y.toCSS,"css"),y=Math.min(r,a),S=Math.min(t,l),v=Math.abs(a-r),d=Math.abs(l-t);return b.jsx("div",{className:m?.(e),style:{position:"absolute",backgroundColor:"#0000ff22",left:`${y}px`,top:`${S}px`,width:`${v}px`,height:`${d}px`,pointerEvents:"none",...s?.(e)}})};g.__docgenInfo={description:"",methods:[],displayName:"SelectBox",props:{makeClassName:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectState: SpanSelectEvent) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  frame: PlotDrawFrame;
  mode: "x" | "y" | "box" | "none";
  x: {
    fromCSS: number;
