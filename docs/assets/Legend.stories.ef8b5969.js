var C=Object.defineProperty;var g=(e,t)=>C(e,"name",{value:t,configurable:!0});import{d as y,g as L,c as k}from"./main.es.62385bb5.js";import{a as M,E as _}from"./helpers.4143dc7f.js";import{j as A}from"./jsx-runtime.3513c91a.js";import"./iframe.0cbb6995.js";const W=g(e=>{let t=0;const s=20*e.length;return L({onHover:({position:n,self:l})=>{l.setState(()=>n)},pluginOpts:{initState:()=>{},transformInputParams({inputParams:n}){const l=k.normalizePadding(n.padding);return t=l.bottom,{...n,padding:{...l,bottom:l.bottom+s}}},transformFrame({frame:n,self:l}){var u,h;const{ctx:r,canvasSize:w,chartArea:f,inputParams:{series:d}}=n,x=k.findClosestDataPoint(l.state,n),p=(u=n.inputParams.facets)!=null?u:[];p.push({type:"custom",draw(){var S,b,I;r.fillStyle="red";const o=w.height-t-s,P=Math.max(...d.map((a,z)=>r.measureText(e[z].label).width))+60,m=f.x+(f.width-P)/2;r.strokeRect(m,o,P,s);for(let a=0;a<d.length;a++)r.fillStyle=e[a].color,r.fillRect(m,o+a*20,20,20),r.fillStyle="black",r.fillText(`${e[a].label} ${(I=(b=(S=x[a])==null?void 0:S.y)==null?void 0:b.toFixed(2))!=null?I:""}`,m+22,o+a*20+15)}});for(let o=0;o<d.length;o++){const c=x[o];if(!c)break;p.push({type:"circle",layer:"top",x:c.x,y:c.y,radius:5,xScaleId:d[o].xScaleId,yScaleId:d[o].yScaleId,style:{fillStyle:e[o].color}})}return{...n,inputParams:{...(h=n.inputParams)!=null?h:{},facets:p}}}}})},"makeLegendPlugin"),i=["red","blue","orange","purple"],R={parameters:{storySource:{source:`import React from "react";
...
//# sourceMappingURL=Legend.stories.ef8b5969.js.map
