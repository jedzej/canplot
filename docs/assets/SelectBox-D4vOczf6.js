import{j as f}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-Aps066pu.js";import{u as w}from"./ChartAreaInteractions-BfourqYk.js";import{f as m,g as s}from"./frameContext-DY6mtHib.js";const h=({makeClassName:o,makeStyle:y})=>{const[e,d]=u.useState(null);w("spanselect",n=>{d(n.mode==="below_threshold"||n.completed?null:n)});const r=u.useMemo(()=>{if(!e||e.mode==="below_threshold")return null;const n=e.mode==="y"?-1/0:e.x.css?.from??-1/0,b=e.mode==="y"?1/0:e.x.css?.to??1/0,v=e.mode==="x"?-1/0:e.y.css?.from??-1/0,c=e.mode==="x"?1/0:e.y.css?.to??1/0,a=m(e.frame,n,"css"),t=m(e.frame,b,"css"),l=s(e.frame,v,"css"),i=s(e.frame,c,"css"),p=Math.min(a,t),k=Math.min(l,i),g=Math.abs(t-a),S=Math.abs(i-l);return{leftPx:p,topPx:k,widthPx:g,heightPx:S}},[e]);return f.jsx("div",{className:e?o?.(e):void 0,style:{position:"absolute",visibility:e?"visible":"hidden",left:`${r?.leftPx??0}px`,top:`${r?.topPx??0}px`,width:`${r?.widthPx??0}px`,height:`${r?.heightPx??0}px`,pointerEvents:"none",...e?y?.(e):void 0}})};h.__docgenInfo={description:"",methods:[],displayName:"SelectBox",props:{makeClassName:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectState: SpanSelectEvent) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  frame: PlotDrawFrame;
...
>`},{name:"Partial",elements:[{name:"CanvasTextDrawingStyles"}],raw:"Partial<CanvasTextDrawingStyles>"}],required:!1}}]}},{name:"signature",type:"object",raw:"{ cssRect: Rect; canvasRect: Rect }",signature:{properties:[{key:"cssRect",value:{name:"signature",type:"object",raw:`{
  ...
  shiftKey: boolean;
  metaKey: boolean;
}`,signature:{properties:[{key:"ctrlKey",value:{name:"boolean",required:!0}},{key:"altKey",value:{name:"boolean",required:!0}},{key:"shiftKey",value:{name:"boolean",required:!0}},{key:"metaKey",value:{name:"boolean",required:!0}}]},required:!0}},{key:"toNormalized",value:{name:"signature",type:"function",raw:'(value: number, axis: "x" | "y") => number | null',signature:{arguments:[{type:{name:"number"},name:"value"},{type:{name:"union",raw:'"x" | "y"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'}]},name:"axis"}],return:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]}},required:!0}},{key:"fromNormalized",value:{name:"signature",type:"function",raw:'(normalized: number, axis: "x" | "y") => number | null',signature:{arguments:[{type:{name:"number"},name:"normalized"},{type:{name:"union",raw:'"x" | "y"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'}]},name:"axis"}],return:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]}},required:!0}}]}},name:"selectState"}],return:{name:"string"}}},description:""},makeStyle:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectState: SpanSelectEvent) => React.CSSProperties | undefined",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  frame: PlotDrawFrame;
  mode: "x" | "y" | "box" | "below_threshold";
  x: {
    css?: { from: number; to: number };
...
>`},{name:"Partial",elements:[{name:"CanvasTextDrawingStyles"}],raw:"Partial<CanvasTextDrawingStyles>"}],required:!1}}]}},{name:"signature",type:"object",raw:"{ cssRect: Rect; canvasRect: Rect }",signature:{properties:[{key:"cssRect",value:{name:"signature",type:"object",raw:`{
  ...
  shiftKey: boolean;
  metaKey: boolean;
}`,signature:{properties:[{key:"ctrlKey",value:{name:"boolean",required:!0}},{key:"altKey",value:{name:"boolean",required:!0}},{key:"shiftKey",value:{name:"boolean",required:!0}},{key:"metaKey",value:{name:"boolean",required:!0}}]},required:!0}},{key:"toNormalized",value:{name:"signature",type:"function",raw:'(value: number, axis: "x" | "y") => number | null',signature:{arguments:[{type:{name:"number"},name:"value"},{type:{name:"union",raw:'"x" | "y"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'}]},name:"axis"}],return:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]}},required:!0}},{key:"fromNormalized",value:{name:"signature",type:"function",raw:'(normalized: number, axis: "x" | "y") => number | null',signature:{arguments:[{type:{name:"number"},name:"normalized"},{type:{name:"union",raw:'"x" | "y"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'}]},name:"axis"}],return:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]}},required:!0}}]}},name:"selectState"}],return:{name:"union",raw:"React.CSSProperties | undefined",elements:[{name:"ReactCSSProperties",raw:"React.CSSProperties"},{name:"undefined"}]}}},description:""}}};export{h as S};
